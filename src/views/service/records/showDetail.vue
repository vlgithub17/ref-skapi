...
.content
    ...
    .row
        ...
        textarea.value(v-model="selectedRecord_data" @keydown.stop="handleKey" style="width:100%;height:160px;resize: none;tab-size: 2;font-family: monospace;white-space: pre;" name='data'
