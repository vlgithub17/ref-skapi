...
main#serviceList
    ...
    div(style='padding:0 8px;')
        ...
        //- img.loading(v-if="callServiceList" style='height:1.6rem;width:1.6rem;padding:4px;' src="@/assets/img/loading.png")
    Table
        ...
        template(v-slot:body)
            ...
            tr(v-else-if="!Object.keys(serviceIdList).length")
                td(colspan="6") No services found.
            ...
            template(v-for="(id, index) in serviceIdList")
                template(v-if="serviceList[id]")
                    tr.serviceRow(ref="tr" @click="(e) => goServiceDashboard(e, serviceList[id])" @mousedown="(e) => e.currentTarget.classList.add('active')" @mouseleave="(e) => e.currentTarget.classList.remove('active')")
                        ...
                        td.center
                            // active state
                            .state(v-if="serviceList[id].service.active > 0" style="color:var(--text-green)") Running
